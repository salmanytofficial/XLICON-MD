...
let cc = Config.sessionName.replace(/XLICON-MD;;;/g, "").replace(/Secktor;;;/g, ""); // Dont Remove "Secktor;;;" So that You Can Use Secktor Qr too in your bot
...
setTimeout(() => {
	...
	try{
		...
		console.log('Could not connect with Mongodb.\nPlease visit https://github.com/salmanytoffcial/XLICON-MD')
	}
    }
    main()
    //========================================================================================================================================
...
Promote ${tlang().title} as admin to treat these
link senders.
`,
                                    ...
                                    citel.reply("sᴜsᴘɪᴄɪᴏᴜs ʟɪɴᴋ ᴅᴇᴛᴇᴄᴛᴇᴅ!!☡");
...
`)
                ...
                for (let jid of mentionUser) {
                    ...
                    reply(`
Hello ${citel.pushName} \n\n, ᴛʜɪꜱ ɪꜱ *${tlang().title}* ᴀ ᴍᴜʟᴛɪᴅᴇᴠɪᴄᴇ ʙᴏᴛ.
ᴅᴏɴ'ᴛ ᴛᴀɢ ʜɪᴍ,ʜᴇ ɪꜱ ʙᴜꜱʏ ɴᴏᴡ. ʙᴜᴛ ᴅᴏɴ'ᴛ ᴡᴏʀʀʏ ɪ ᴀꜱꜱᴜʀᴇ ʏᴏᴜ,ɪ'ʟʟ ɪɴꜰᴏʀᴍ ʜɪᴍ ᴀꜱ ꜱᴏᴏɴ ᴀꜱ ᴘᴏꜱꜱɪʙʟᴇ😊.
